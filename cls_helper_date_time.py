...
class DateTimeHelper:
    ...
    def get_ordinal_suffix(self, day)->str:
        if 10 <= day % 100 <= 20:
            suffix = "th"
        else:
    ...
    def reformat_date_str(self, date_str, from_format, to_format)->str:
