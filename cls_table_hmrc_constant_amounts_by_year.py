...
class HMRC_ConstantAmountsByYear(SQLiteTable):
    ...
    def get_basic_rate_threshold(self) -> Decimal:
        basic_rate_threshold = self.__get_value_by_hmrc_constant("Basic rate threshold")
    ...
    def get_class_2_weekly_rate(self) -> Decimal:
        class_2_nics_weekly_rate = self.__get_value_by_hmrc_constant(
    ...
    def get_class_4_lower_profits_limit(self) -> Decimal:
        class_4_lower_profits_limit = self.__get_value_by_hmrc_constant(
    ...
    def get_class_4_upper_profits_limit(self) -> Decimal:
        class_4_upper_profits_limit = self.__get_value_by_hmrc_constant(
    ...
    def get_dividends_allowance(self) -> Decimal:
        dividends_allowance = self.__get_value_by_hmrc_constant("Dividends allowance")
    ...
    def get_higher_rate_threshold(self) -> Decimal:
        higher_rate_threshold = self.__get_value_by_hmrc_constant(
    ...
    def get_marriage_allowance(self) -> Decimal:
        marriage_allowance = self.__get_value_by_hmrc_constant("Marriage allowance")
    ...
    def get_personal_allowance(self) -> Decimal:
        personal_allowance = self.__get_value_by_hmrc_constant("Personal allowance")
    ...
    def get_personal_savings_allowance(self) -> Decimal:
        personal_savings_allowance = self.__get_value_by_hmrc_constant(
    ...
    def get_property_income_allowance(self) -> Decimal:
        property_income_allowance = self.__get_value_by_hmrc_constant(
    ...
    def get_savings_nil_band(self) -> Decimal:
        savings_nil_band = self.__get_value_by_hmrc_constant("Savings nil band")
    ...
    def get_small_profits_threshold(self) -> Decimal:
        small_profits_threshold = self.__get_value_by_hmrc_constant(
    ...
    def get_starting_rate_limit_for_savings(self) -> Decimal:
        starting_rate_limit_for_savings = self.__get_value_by_hmrc_constant(
    ...
    def get_trading_income_allowance(self) -> Decimal:
        ...
        trading_income_allowance = self.__get_value_by_hmrc_constant(
    ...
    def get_vat_registration_threshold(self) -> Decimal:
        vat_registration_threshold = self.__get_value_by_hmrc_constant(
    ...
    def get_weekly_state_pension(self) -> Decimal:
        weekly_state_pension = self.__get_value_by_hmrc_constant("Weekly state pension")
